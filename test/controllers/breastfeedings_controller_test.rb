...
class BreastfeedingsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create breastfeeding" do
    assert_difference('Breastfeeding.count') do
      post breastfeedings_url, params: { breastfeeding: { cantidad: @breastfeeding.cantidad, duracion: @breastfeeding.duracion, fecha: @breastfeeding.fecha } }
    end
  ...
  test "should update breastfeeding" do
    patch breastfeeding_url(@breastfeeding), params: { breastfeeding: { cantidad: @breastfeeding.cantidad, duracion: @breastfeeding.duracion, fecha: @breastfeeding.fecha } }
